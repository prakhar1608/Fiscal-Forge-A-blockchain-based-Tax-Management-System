  ...
  return (
    <div className="about-container">
      ...
      <div className="about-content">
        <h1>About Fiscal Forge Project</h1>
        <p>
        ...
        <p>
          Our project, Fiscal Forge, aims to address this critical issue by developing a decentralized application (DApp) that promotes financial transparency in government operations. The DApp leverages blockchain technology and smart contracts to create an immutable, tamper-resistant, and publicly accessible ledger of all government financial transactions.
        </p>
      </div>
    </div>
  );
